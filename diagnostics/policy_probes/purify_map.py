...
Dual-mode so the figure re-renders without recomputing:
  compute: PYTHONPATH=. python diagnostics/policy_probes/purify_map.py --ckpt <path>
  plot:    PYTHONPATH=. python diagnostics/policy_probes/purify_map.py --plot --out_dir <dir>
"""
...
# feature schema
# ----------------------------------------------------------------------------
from diagnostics.policy_probes._collect import FEATURE_NAMES, greedy  # noqa: E402
