...
class LegacyBackend(PhysicsBackend):
    ...
    def node_state(self, node: int) -> NodeState:
        ...
        return NodeState(
            ...
            occupied=_freeze(occupied.copy()),
            locked=_freeze(rep.locked.copy()),
            partner_node=_freeze(rep.partner_repeater.copy()),
            partner_qubit=_freeze(rep.partner_qubit.copy()),
